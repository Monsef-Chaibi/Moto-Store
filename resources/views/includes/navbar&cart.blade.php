	...
	<header>
		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop {{ !request()->is('/') ? 'shadow-md' : '' }}">
				<nav class="limiter-menu-desktop container">

					<!-- Logo desktop -->
					<a href="/" class="logo">
						<img src="{{ asset('TemplateFile/images/icons/logo-01.png')}}" alt="IMG-LOGO">
					</a>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="{{ asset('TemplateFile/images/icons/logo-01.png')}}" alt="IMG-LOGO"></a>
			</div>
		...
		<div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
			<div class="container-search-header">
				<button class="flex-c-m btn-hide-modal-search trans-04 js-hide-modal-search">
					<img src="{{ asset('TemplateFile/images/icons/icon-close2.png')}}" alt="CLOSE">
				</button>
				...
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="{{ asset('TemplateFile/images/item-cart-01.jpg')}}" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="{{ asset('TemplateFile/images/item-cart-02.jpg')}}" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="{{ asset('TemplateFile/images/item-cart-03.jpg')}}" alt="IMG">
						</div>
